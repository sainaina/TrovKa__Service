...
export const SearchFilterHorizontal = () => {
  ...
  return (
    <>
      ...
      <Metadata
        title="Service | Troka"
        description="Browse all available services in Cambodia and find the perfect match for your needs"
        author="TrovKa Team"
          ...
          <div className="flex flex-row flex-wrap items-center justify-center z-20 -mt-4 sm:mt-0">
            ...
            <div className="relative flex-shrink-0 mx-2">
              <button
                ...
                className="flex justify-between border rounded-[8px] border-gray-500 w-full md:w-[150px]  pl-2 py-2 text-gray-500"
              >
                {sortCriteria || "Sort"} <RiArrowDropDownLine className="text-2xl md:text-3xl" />
              </button>
              {isCategoryOpen && (
            ...
            <div className="flex flex-shrink-0 mx-2">
              <button onClick={handleGridNavigate} className="flex justify-center items-center border border-gray-500 rounded-l-lg h-[48px] w-[40px] md:w-[50px] sm:w-[50px] lg:w-[50px] text-black  ">
                <TbGridDots className="text-gray-500 " />
              </button>

              <button

                className="flex justify-center items-center border border-gray-500 rounded-r-lg  h-[48px] w-[40px] lg:w-[50px] md:w-[50px] sm:w-[50px] bg-Secondary dark:bg-Primary text-black dark:text-gray-500"
              >
